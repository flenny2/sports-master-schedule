...
<div class="wrap">
  ...
  <section class="decide">
    ...
    <div class="opt">
      <span class="opt-name">1 · Seven defects — one word does it</span>
      <span class="muted">All measured, fixed and verified. Reply <b>keep all seven</b>, or
      name the ones you want out. The next block makes the case in seven lines.</span>
    </div>
    <div class="opt">
      <span class="opt-name">2 · SMS-5 — already parked, at your word</span>
      <span class="muted">You said "I will wait" for a sitting with the screenshots. Nothing
      is owed until then — both versions are below whenever you want to look.</span>
    </div>
    <div class="opt">
  ...
  <section class="decide" style="border-left-color:#4ADE80">
    <h2 style="color:inherit">The seven, in one screen</h2>
    <p class="muted">Every one is a defect that was measured, fixed and verified against the
    running app. None changes how anything works on purpose. <b>My recommendation is keep all
    seven</b> — the case for each is one line:</p>
    <ol class="list">
      <li><b>SMS-4</b> — the tab row hid behind the iPhone clock when you scrolled, and 16 of
        71 things you can tap were smaller than a fingertip.</li>
      <li><b>SMS-6</b> — the settings that go stale every August are a command now, not a note,
        and the one real bug on that list (a wrong "matches left" for some leagues) is fixed.</li>
      <li><b>SMS-7</b> — the Calendar's storyline filter expired on 31 May and had been gone for
        two months.</li>
      <li><b>SMS-8</b> — the banner card was cutting "CAROLINA PANTHERS" in half.</li>
      <li><b>SMS-9</b> — Home was showing two cards for the same Premier League story.</li>
      <li><b>SMS-10</b> — the button that spends money was too small to hit reliably, and so was
        Refresh.</li>
      <li><b>SMS-11</b> — cards claimed league positions before anyone had played a match.</li>
    </ol>
    <div class="rec">
      <b>One word answers all seven.</b> Reply <code>keep all seven</code> and they merge to
      <code>master</code> alongside SMS-1..3 — still unpushed, still your hand. If you want any
      one of them out, name it: <code>keep all seven except 8</code>.
      <br><br>
      The full case, risks and pictures for each are further down. They are there if you want
      them, not because you need them to answer.
    </div>
  </section>
...
you    FANTASY_ROSTER
    ...
    <article class="prop">
      ...
      <dl>
        ...
        <div class="verdict"><dt>Keep / discard</dt><dd>DEFERRED by you, 27 July — "I will wait" for a sitting where you can see both. Not being re-asked; it is here so the pictures are in front of you when you want them.</dd></div>
      </dl>
    </article>
